  ...
  <body>
    	...
    	<div class="container-wrap ml-auto">
          ...
          <div class="col-md-12 nav-link-wrap">
            <div class="nav nav-pills justify-content-center text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">Experience</a>
            </div>
          </div>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h4 class="mb-4">See our latest vacation ideas</h4>
          </div>
        </div>
        <div class="row">
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="destination-entry img" style="background-image: url(images/destination-1.jpg);">
        			<div class="text text-center">
        				<h5>Beachfront Scape</h5>
        			</div>
        		</a>
        	</div>
        	<div class="col-md-4 ftco-animate">
        		<a href="#" class="destination-entry img" style="background-image: url(images/group-holiday.jpg);">
        			<div class="text text-center">
        				<h5>Group Holidays</h5>
        			</div>
        		</a>
        	</div>
        	<div class="col-md-4 ftco-animate">
    ...
    <section class="ftco-section">
    	<div class="container">
				<div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h4 class="mb-4">Most Popular Destination</h4>
          </div>
        </div>    		
    	</div>
    				...
    				<div class="destination">
    					...
    					<div class="text p-3">
    						...
    						<p class="bottom-area d-flex">
    							<span><i class="icon-map-o"></i> Krabi, Thailand</span> 
    			...
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination d-md-flex flex-column-reverse">
    					...
    					<div class="text p-3">
    						...
    						<hr>
    						<p class="bottom-area d-flex">
    							<span><i class="icon-map-o"></i> London, UK</span> 
    							<span class="ml-auto"><a href="#">Discover</a></span>
    						</p>
    					</div>
    				</div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text">
                ...
                <h5 class="heading mt-3"><a href="#">8 Best homestay in Philippines that you don't miss out</a></h5>
                <div class="meta mb-3">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text">
                ...
                <h5 class="heading mt-3"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h5>
                <div class="meta mb-3">
                  <div><a href="#">October 3, 2018</a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
